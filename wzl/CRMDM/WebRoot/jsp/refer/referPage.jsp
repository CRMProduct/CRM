...
<html>
 ...
 <a href="jsp/updateReferStudent.jsp" style=" text-decoration: none;">添加</a></div><br><br>
  ...
  <h4 align="left" style="position:relative;left: 50px;color: orange ">查询结果</h4>
   <table width="90%" border="1px" >
    ...
    <c:if test="pageBean.list!= null"></c:if>
     ...
     <td><a href="Refer_findReferStudent1?referId=${refer.referId}&pageCpde=${ pageBean.pageCode}"style="text-decoration: none;">查看</a></td>
     <td><a href="Refer_findReferStudent2?referId=${refer.referId}&pageCpde=${ pageBean.pageCode}" style="text-decoration: none;">编辑</a></td>
     <td><a href="jsp/addFollow.jsp">跟踪</a></td>
     <td><a href="jsp/addSchoolRoll.jsp" style=" text-decoration: none;">录入学籍</a></td>
    </tr>

...
<html>
  ...
  <a href="Refer_queryRefer" style="text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;<font style=" font-size: 9px">咨询学生管理</font></a><br>
  <a href="" style="text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;<font style=" font-size: 9px">查询报名学生</font></a><br>
  </td></tr>
  <tr><td>
  <font style=" font-size:13px">学工部</font><br>
  <a href="Student_query" style="text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;<font style=" font-size: 9px">在校学生管理</font></a><br>
  ...
  <a href="Class_queryClass" style="text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;<font style=" font-size: 9px">班级管理</font></a><br>
  <a href="Course_queryCourse" style="text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;<font style=" font-size: 9px">课程类别</font></a><br>
  </td></tr>
  <tr><td>
   <font style=" font-size:13px">就业部</font><br>
  <a href="Graduate_queryGraduate" style="text-decoration: none;">&nbsp;&nbsp;&nbsp;&nbsp;<font style=" font-size: 9px">就业情况</font></a><br>
  </td></tr>
  <tr><td>

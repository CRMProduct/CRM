...
CREATE TABLE `crmstaff` (
  ...
  CONSTRAINT `crmstaff_ibfk_2` FOREIGN KEY (`depId`) REFERENCES `crmdepartment` (`depId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `crmpost` VALUES ('3', '2', '2');
INSERT INTO `crmpost` VALUES ('4', '校长', '2');
INSERT INTO `crmpost` VALUES ('5', 'xiaozhan', '2');
INSERT INTO `crmpost` VALUES ('6', '222', '2');
INSERT INTO `crmpost` VALUES ('7', '1122', '2');
INSERT INTO `crmstaff` VALUES ('1', 'gjn', '1111', '葛京能', '男', '2017/10/12', '1', '1');
INSERT INTO `crmstaff` VALUES ('2', 'wzl', '1111', '吴兆龙', '男', '2017/10/12', '1', '1');
INSERT INTO `crmstaff` VALUES ('3', 'wd', '1111', '吴东', '男', '2017/10/12', '2', '2');
INSERT INTO `crmstaff` VALUES ('4', 'jy', '1111', '景阳', '女', '2017/10/12', '3', '2');
INSERT INTO `crmstaff` VALUES ('5', '11', null, '33', '男', '1111111111', '2', '2');

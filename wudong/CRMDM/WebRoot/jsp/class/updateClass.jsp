...
<input type="hidden" name="classId" value="${crmclass.classId }"> 
<input type="hidden" name="status" value="${crmclass.status }">
 <input type="hidden" name="upgradeCount" value="${crmclass.upgradeCount }">
 <input type="hidden" name="changeCount" value="${crmclass.changeCount }">
 <input type="hidden" name="runoffCount" value="${crmclass.runoffCount }">  
 <input type="hidden" name="uploadPath" value="${crmclass.uploadPath }">   
 <input type="hidden" name="uploadFileName" value="${crmclass.uploadFileName }">
 <input type="hidden" name="uploadTime" value="${crmclass.uploadTime }">

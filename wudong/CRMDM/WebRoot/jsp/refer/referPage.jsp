...
<html>
 ...
 &emsp;&emsp;&emsp;查询条件：<input type="text" name="condition">(姓名|电话|QQ)
 <input type="submit" value="查询">
 </form>
 <br>
  <center>
  <h4 align="left" style="position:relative;left: 50px;color: orange ">查询结果</h4><br>
   <table width="90%" border="1px" bordercolor="#999999;">
    ...
    <c:if test="pageBean.list!= null"></c:if>
     ...
     <td><a href="Refer_find?referId=${refer.referId}" ><img src="imgs/luru.png" border="none"/></a></td>
    </tr>

...
<html>
 ...
 <div style="position: relative; top: 5px;left: 80%">
 <a href="jsp/refer/updateReferStudent.jsp" style=" text-decoration: none;">添加</a>
  <a href="Refer_queryRefer" style="text-decoration: none;">返回</a>
 </div><br><br>
<form action="Refer_search" method="post">
 &emsp;&emsp;&emsp;查询条件：<input type="text" name="condition" value="${condition }">(姓名|电话|QQ)
  ...
  <h4 align="left" style="position:relative;left: 50px;color: orange ">查询结果</h4>
   <table width="90%" border="1px" bordercolor="#999999;">
    ...
    <tr>
     ...
     <a href="Refer_search?pageCode=${pageBean.pageCode-1 }" style="text-decoration: none;">上一页</a>
     </c:if>
     <c:forEach var="pageCode" begin="1" end="${pageBean.allPages }">
      <a href="Refer_search?pageCode=${pageCode }" style="text-decoration: none;">[${pageCode }]</a>
     </c:forEach>
     <c:if test="${pageBean.pageCode<pageBean.allPages }">
     <a href="Refer_search?pageCode=${pageBean.pageCode+1 }" style="text-decoration: none;">下一页</a>
     </c:if>
     <a href="Refer_search?pageCode=${pageBean.allPages }" style="text-decoration: none;">末页</a>
     </td>
     <td colspan="2">
       <form action="Refer_search">

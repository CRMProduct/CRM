...
public class Crmstudent implements java.io.Serializable {
	...
	/** full constructor */
	public Crmstudent(Crmrefer crmrefer, String studentName, String telephone, String identity, String qq,
			String gender, Integer mustTuition, Integer actualTuition, String email, String school, String education,
			String professional, String identityAddress, String address, String remark, String homeTelephone,
			String homeContact, Integer classId, Set crmgraduates, Set crmstations, Set crmrunoffs) {
